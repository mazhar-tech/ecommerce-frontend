...
import { getProductDetailImageUrl } from '../../lib/imageUtils';
            ...
            <div className='product-detail-container'>
                <div className='product-images'>
                    <div className='small-images-container'>
                        {image?.map((item, ind) => (
                            <img 
                            key={ind}
                            src={getProductDetailImageUrl(item)} 
                    ...
                    <div className='big-image-container'>
                        <img src={getProductDetailImageUrl(image && image[index])} alt={name} />
                    </div>
                </div>
                <div className='product-details'>
                    ...
                    <div className='add-to-cart'>
                        ...
                        <p className='price'>{formatCurrencyCompact(price)}</p>  
                    </div>
                </div>
            </div>
